 ...
 * another by them. {@code cameraSettings} is null if the user never changed them. The password hash and the extension token are never included. Add new kinds of
