...
class SecurityConfigurationIntegrationTest extends ApiIntegrationTest {
    ...
    private static Stream<String[]> protectedEndpoints() {
        return Stream.of(
                ...
                new String[] {"GET", "/api/focus-sessions/1/off-task"},
                new String[] {"POST", "/api/focus-sessions/1/off-task/disputes"},
                ...
                new String[] {"GET", "/api/me/camera-settings"},
                new String[] {"PUT", "/api/me/camera-settings"},
                new String[] {"GET", "/api/camera/profiles"},
                new String[] {"POST", "/api/me/companion-token"},
                new String[] {"DELETE", "/api/me/companion-token"},
                new String[] {"POST", "/api/companion/heartbeat"},
                new String[] {"POST", "/api/companion/observations"},
